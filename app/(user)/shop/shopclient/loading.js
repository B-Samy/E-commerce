...
<div className="grid_container">
      {[...Array(4)].map((_, idx) => (
        <div key={idx} className="qwe123_card">
          <div className="rty456_cardImage">
            <div className="uio789_block uio789_pulsate"></div>
            <svg
              className="fgh987_fpo"
              width="84px"
              height="63px"
              x="50%"
              y="50%"
          ...
          <div className="zxc321_cardContent">
            <div className="vbn654_block2 vbn654_pulsate"></div>
            <div className="mko852_block3 mko852_pulsate"></div>
            <div className="asd741_circle asd741_pulsate"></div>
